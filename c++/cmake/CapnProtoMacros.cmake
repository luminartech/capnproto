...
function(CAPNP_GENERATE_EXPORT_TAGS EXPORT_TAGS)
  message("trying to read header files")
  set(${EXPORT_TAGS})
  foreach(schema_file ${ARGN})
    ...
    if (CMAKE_MATCH_COUNT GREATER 0)
      list(APPEND ${EXPORT_TAGS} "CAPNP_${CMAKE_MATCH_1}_EXPORTS")
    endif()
  endforeach()

  set(${EXPORT_TAGS} ${${EXPORT_TAGS}} PARENT_SCOPE)
endfunction()
